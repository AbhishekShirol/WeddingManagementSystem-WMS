...
//             <Link to="/user/catering" className="text-decoration-none text-dark">
...
//           {/* Music Service Card */}
//           <div className="col-md-4 mb-4 d-flex justify-content-center">
//             <Link to="/user/music" className="text-decoration-none text-dark">
//               <div className="card" style={{ width: '300px', height: '400px', position: 'relative', overflow: 'hidden' }}>
...
//           <div className="col-md-4 mb-4 d-flex justify-content-center">
//             <Link to="/user/decoration" className="text-decoration-none text-dark">
//               <div className="card" style={{ width: '300px', height: '400px', position: 'relative', overflow: 'hidden' }}>
...
//           {/* Venue Service Card */}
//           <div className="col-md-4 mb-4 d-flex justify-content-center">
//             <Link to="/user/venues" className="text-decoration-none text-dark">
//               <div className="card" style={{ width: '300px', height: '400px', position: 'relative', overflow: 'hidden' }}>
