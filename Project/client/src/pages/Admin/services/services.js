...
// function Services() {
//   return (
//     <div style={{ minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', overflow: 'hidden', backgroundColor:'#87CEEB80'}}>
...
function Services() {
  return (
    <div 
      ...
      // style={{ backgroundColor: '#87CEEB80' }} // Light blue color with some opacity
    >
      ...
      <div className="position-relative container px-4">
        ...
        >
          ...
          {/* Venue Service Card */}
          <div className="mx-3">
            <Link to="/admin/venues" className="text-decoration-none text-dark">
              <div className="card" style={{ width: '250px', height: '350px', position: 'relative', overflow: 'hidden' }}>
                <img 
