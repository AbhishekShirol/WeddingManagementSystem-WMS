...
// const VenueService = () => {
//   const [venueList, setVenueList] = useState([]);
//   const [newVenue, setNewVenue] = useState({ location: '', description: '', capacity: '', price: '', imageUrl: '', availability: '' });
//   const [editingId, setEditingId] = useState(null);
//   const [editVenue, setEditVenue] = useState({ location: '', description: '', capacity: '', price: '', imageUrl: '', availability: '' });
...
//       const response = await axios.post('http://localhost:5000/api/venue', newVenue);
//       setVenueList([...venueList, response.data]);
//       setNewVenue({ location: '', description: '', capacity: '', price: '', imageUrl: '', availability: '' });
//     } catch (error) {
//       console.error('Error adding venue:', error);
//     }
//   };
...
//       );
//       setEditingId(null);
//       setEditVenue({ location: '', description: '', capacity: '', price: '', imageUrl: '', availability: '' });
//     } catch (error) {
//       console.error('Error updating venue:', error);
//     }
//   };
...
//     try {
//       const response = await axios.put(`http://localhost:5000/api/venue/${id}`, editVenue);
//       setVenueList(venueList.map((venue) => (venue.id === id ? response.data : venue)));
//       setEditingId(null);
//       setEditVenue({
//         location: '',
//         description: '',
