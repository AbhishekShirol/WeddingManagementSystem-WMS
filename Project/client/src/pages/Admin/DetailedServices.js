    ...
    <div className="container py-5 pt-5">
      <div className="row justify-content-center">
        <div className="col-md-10">
          <div className="mb-4">
            <h2 className="text-danger">Service Details for Registration ID: {registrationId}</h2>
          </div>
          ...
          <div className="row g-4">
            ...
            <div className="col-md-6">
              <div className="card border-danger shadow">
                <div className="card-header bg-danger text-white">Venue</div>
            ...
            <div className="col-md-6">
              <div className="card border-danger shadow">
                <div className="card-header bg-danger text-white">Catering</div>
                <div className="card-body">
            ...
            <div className="col-md-6">
              <div className="card border-danger shadow">
                <div className="card-header bg-danger text-white">Music</div>
                <div className="card-body">
            ...
            <div className="col-md-6">
              <div className="card border-danger shadow">
                <div className="card-header bg-danger text-white">Decoration</div>
                <div className="card-body">
